...
class _MyHomePageState extends State<MyHomePage> {
    ...
    Contato( nome: 'JAVA', email: 'joe_doeoe@gmail.com'),
    Contato( nome: 'Python', email: 'AliceOAustin@rhyta.com'),
    Contato( nome: 'Dart', email: 'DouglasRBrodway@dayrep.com'),
    Contato( nome: 'Cobol', email: 'teste@gmail'),
    Contato( nome: 'C#', email: 'teste@gmail'),
